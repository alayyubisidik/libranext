...
<div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
    <form novalidate action="{{ route('dashboard.books.update', $book) }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="publication_year" id="publication_year" value="{{ old('publication_year', $book->publication_year) }}" min="1900" max="{{ date('Y') + 1 }}"
                               class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">{{ old('description', $book->description) }}</textarea>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200" x-data="{ imagePreview: '{{ $book->hasMedia('cover') ? $book->getFirstMediaUrl('cover') : '' }}', removeCover: false }">
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md relative overflow-hidden group">
                        ...
                        <div x-show="imagePreview" class="absolute inset-0 w-full h-full bg-white z-10 p-1" style="display: none;">
                            ...
                            <button type="button" @click="imagePreview = null; removeCover = true; $refs.coverInput.value = ''" class="absolute top-2 right-2 bg-red-100 text-red-600 rounded-full p-1 hover:bg-red-200">
